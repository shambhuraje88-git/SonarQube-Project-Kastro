pipeline {
    ...
    environment {
        ...
        DOCKERHUB_USERNAME = 'shambhuraje88'  // Set this directly to your Docker Hub username
    ...
    stages {
        stage('Git Checkout') {
            steps {
                git branch: 'main', url: 'https://github.com/shambhuraje88-git/SonarQube-Project-Kastro.git'
            }
        }
